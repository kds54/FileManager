...
CONFIG = {
    ...
    'delete_folder': '/home/sb3/MagicMirror/modules/MMM-Planefinder',
    ...
    'download_folder': '/home/sb3/MagicMirror/modules/MMM-Planefinder',
    
    # Log file path
    'log_file': '/home/sb3/venv/FileManager/FileManager_Log.txt'
}
...
def main():
    ...
    if all_errors:
        print("\n[WARN] Script completed with errors. Check log file for details.")
        sys.exit(1)
    else:
